...
class LogMainView : public AbstractLogView
{
  ...
  public:
    ...
    // The currently-focused line: selected line if any, otherwise the line
    // in the middle of the visible area. Exposed for baretail's bookmark
    // actions; in klogg the equivalent state is read via the protected
    // getViewPosition() accessor on the parent.
